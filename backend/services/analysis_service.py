"""Analysis service: orchestrates AI analysis for pending repositories."""
...
from core.retrieval import generate_dual_repository_embeddings
...
async def run_pending_repository_analysis(db: AsyncSession) -> dict:
    ...
    start_sync(total=total_pending)
        ...
        async def analyze_one(repo_data: dict[str, Any]) -> dict[str, Any]:
            ...
            async with semaphore:
                ...
                try:
                    ...
                    dual_embeddings = await generate_dual_repository_embeddings(combined_data)
                    return {
                        "id": repo_data["id"],
                        "ok": True,
                        "analysis": analysis,
